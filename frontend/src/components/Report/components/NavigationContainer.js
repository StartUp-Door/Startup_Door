...
function NavigationContainer(props) {
  ...
  const items = [
    { text: "Report Main", id: 1, icon: "html", route: "/", selected: true },
    { text: "Invoice", id: 2, icon: "template-manager", route: "/LayoutSample" },
    { text: "Revenue Grid", id: 3, icon: "grid", route: "/GridExport" },
    { text: "TreeList Table", id: 4, icon: "sort-asc", route: "/TreeListExport" }
  ];
