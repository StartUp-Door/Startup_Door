...
export default function GmailTreeView() {
  ...
  return (
    ...
    >
      ...
      <Link to="/plantfeedback" style={{textDecoration:'none'}}>
      <StyledTreeItem nodeId="2" labelText="View Feedbacks" labelIcon={FeedbackIcon} />
      </Link>
      <Link to="/completedworksPlant" style={{textDecoration:'none'}}>
      ...
      <Link to="/pfeed" style={{textDecoration:'none'}}>
      <StyledTreeItem nodeId="5" labelText="Problem Feed" labelIcon={RateReviewIcon}/>
      </Link>
