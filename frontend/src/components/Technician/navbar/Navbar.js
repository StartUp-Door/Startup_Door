...
export default function PrimarySearchAppBar() {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleMenuClose}><Link to="/client" style={{textDecoration:"none", color:"black"}}>Switch to Client</Link></MenuItem>
          ...
          <MenuItem onClick={handleMenuClose1}> 
            ...
            <div>
              ...
              <div style={{fontWeight: 'bold', textAlign:'center', alignItems:'center', paddingBottom: 5}} >
                <span><MonetizationOnRoundedIcon />Given this Job from the bidding. <span style={{fontSize:11, paddingLeft:10, fontWeight:500}}> {format(noti.created_on)} </span>  </span>
              </div>
      ...
      <AppBar position="static" style={{backgroundColor:"#1A2A4A"}}>
        <Toolbar>
          ...
          <div className={classes.search}>
            ...
            <InputBase
              placeholder="Search for a Technical job here…"
              classes={{
          ...
          <div className={classes.sectionDesktop}>
            <IconButton aria-label="show 4 new mails" color="inherit" style={{marginRight:'70px'}}>
              <Badge badgeContent={4} color="secondary">
                <MailIcon />
              </Badge>
            </IconButton>
            <IconButton aria-label="show 4 new notifications" aria-controls={noti} onClick={handleProfileMenuOpen1} color="inherit" style={{marginRight:'70px'}}>
              <Badge badgeContent={Notification && Notification.length} color="secondary">
                <NotificationsIcon />
              </Badge>
            </IconButton>
            <IconButton
